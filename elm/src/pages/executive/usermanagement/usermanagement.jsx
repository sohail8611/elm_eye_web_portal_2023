    ...
    if (this.state.filter == ""){
      ...
      let filter_data = [];
        ...
        this.state.users.forEach(element => {
            if(element.user_id.toString().toLowerCase().indexOf(this.state.filter.toString().toLowerCase()) > -1 || element.fullname.toLowerCase().indexOf(this.state.filter.toString().toLowerCase()) > -1 || element.position.toLowerCase().indexOf(this.state.filter.toString().toLowerCase()) > -1 || element.city_allow.toLowerCase().indexOf(this.state.filter.toString().toLowerCase())> -1){
    ...
    <div>
      ...
      <div style={{width:"100%",height:"40px"}}>
       ...
       <div style={{display:"flex",flexDirection:"row", paddingRight:"50px"}}>
            <div class="input-group mb-3"  style={{flexBasis:"60%",marginLeft:"10px"}}>
                <span class="input-group-text" id="basic-addon1">Search </span>
                <input type="text" class="form-control" value={this.state.filter} onChange={this.handleChange_filter} />
            </div>
       ...
       <div class="form-text w-100" style={{marginTop:"-10px", marginLeft:"10px"}}>
              Type: User ID, Name,	Position,	Allowed City
            </div>
       <br />
        <div class="row">
                    ...
                    <tr>
                        <td>
                          <InputGroup  style={{width:"150px",padding:"5px"}}>
                            <InputGroup.Radio aria-label="Checkbox for following text input" value="Admin" name="group1" checked = {this.state.add_new_user_form.position === "Admin"}
                ...
                <Form.Group className="mb-6">
                  ...
                  <center>
                    <tr>
                        <td>
                          <InputGroup  style={{width:"150px",padding:"5px"}}>
                            <InputGroup.Radio  value="Admin" name="group1" checked = {this.state.edit_user_form.position === "Admin"}
